            ...
            <div class="list-group-item p-0 mb-3 rounded-3 border shadow-sm bg-white">
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col d-flex align-items-center p-4 prepnutie-eventu"
                        ...
                        <div class="text-center border-end pe-4 d-none d-md-block datum-eventu">
                        ...
                        <div class="ms-3">
                            <img src="<?= htmlspecialchars($asset($event->getPlagat() ?: 'images/tat_logo.png'), ENT_QUOTES, 'UTF-8') ?>"
                                 class="rounded shadow-sm mini-obrazok-eventu" alt="event" style="width: 60px; height: 60px; object-fit: cover;">
                        </div>
